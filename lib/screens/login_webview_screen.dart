                      ...
                      child: ClipRRect(
                        ...
                        child: SizedBox(
                          ...
                          child: InAppWebView(
                            ...
                            // iOS: 親から継承されるとされていたが実際は継承されず、
                            //   embedded WKWebView 扱いの UA になって Google に弾かれる。
                            //   iPadOS 17.x の WKWebView クラッシュを避けるため、
                            //   userAgent だけ渡し、JS/Storage 等は親から継承させる
                            //   （これらの再適用が過去にクラッシュ要因だったため）。
